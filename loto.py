...
hod = random.sample(range(90), 30)
p1_hod = random.sample(hod, 15)
p2_hod = [e for e in hod if not e in p1_hod]
p1_field = [p1_hod[:5], p1_hod[5:10], p1_hod[10:]]
p2_field = [p2_hod[:5], p2_hod[5:10], p2_hod[10:]]
...
for ball in bochonki:
    bochonkileft -= 1
    print('\nНовый бочонок: {} (осталось: {})\n'.format(ball, bochonkileft))
    field(0)
    field(1)
    if you_move() == 1:
        p1 -= 1
